...
var publishSubscribeExamResults = (() => {
  var subscribers = [];
  var subscribe = (user) => subscribers.push(user);
  var publish = () => {
    subscribers.forEach((subscriber) =>
      console.log(`${subscriber} is published!`)
    );
  };
  return {
    subscribe,
...
names.forEach((name) => publishSubscribeExamResults.subscribe(name));
